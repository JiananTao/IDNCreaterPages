 ...
 * limitations under the License.
 */
class C extends k.ZR{constructor(e,t,n=0){super(x(e),`Firebase Storage: ${t} (${x(e)})`),this.status_=n,this.customData={serverResponse:null},this._baseMessage=this.message,Object.setPrototypeOf(this,C.prototype)}get status(){return this.status_}set status(e){this.status_=e}_codeEquals(e){return x(e)===this.code}get serverResponse(){return this.customData.serverResponse}set serverResponse(e){this.customData.serverResponse=e,this.customData.serverResponse?this.message=`${this._baseMessage}\n${this.customData.serverResponse}`:this.message=this._baseMessage}}var O,N;function x(e){return"storage/"+e}function I(){const e="An unknown error occurred, please check the error payload for server response.";return new C(O.UNKNOWN,e)}function D(e){return new C(O.OBJECT_NOT_FOUND,"Object '"+e+"' does not exist.")}function P(e){return new C(O.QUOTA_EXCEEDED,"Quota for bucket '"+e+"' exceeded, please view quota on https://firebase.google.com/pricing/.")}function L(){const e="User is not authenticated, please authenticate using Firebase Authentication and try again.";return new C(O.UNAUTHENTICATED,e)}function F(){return new C(O.UNAUTHORIZED_APP,"This app does not have permission to access Firebase Storage on this project.")}function q(e){return new C(O.UNAUTHORIZED,"User does not have permission to access '"+e+"'.")}function B(){return new C(O.RETRY_LIMIT_EXCEEDED,"Max retry time for operation exceeded, please try again.")}function M(){return new C(O.CANCELED,"User canceled the upload/download.")}function z(e){return new C(O.INVALID_URL,"Invalid URL '"+e+"'.")}function j(e){return new C(O.INVALID_DEFAULT_BUCKET,"Invalid default bucket '"+e+"'.")}function H(){return new C(O.NO_DEFAULT_BUCKET,"No default bucket found. Did you set the '"+R+"' property when initializing the app?")}function V(){return new C(O.CANNOT_SLICE_BLOB,"Cannot slice blob for upload. Please retry the upload.")}function W(){return new C(O.SERVER_FILE_WRONG_SIZE,"Server recorded incorrect upload file size, please retry the upload.")}function $(){return new C(O.NO_DOWNLOAD_URL,"The given file does not have any download URLs.")}function G(e){return new C(O.UNSUPPORTED_ENVIRONMENT,`${e} is missing. Make sure to install the required polyfills. See https://firebase.google.com/docs/web/environments-js-sdk#polyfills for more information.`)}function X(e){return new C(O.INVALID_ARGUMENT,e)}function K(){return new C(O.APP_DELETED,"The Firebase app was deleted.")}function Z(e){return new C(O.INVALID_ROOT_OPERATION,"The operation '"+e+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}function J(e,t){return new C(O.INVALID_FORMAT,"String does not match format '"+e+"': "+t)}function Y(e){throw new C(O.INTERNAL_ERROR,"Internal error: "+e)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ee={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class Re{constructor(e,t){this.data=e,this.contentType=t||null}}function Ae(e,t){switch(e){case Ee.RAW:return new Re(Se(t));case Ee.BASE64:case Ee.BASE64URL:return new Re(Ce(e,t));case Ee.DATA_URL:return new Re(Ne(t),xe(t))}throw I()}function Se(e){const t=[];for(let n=0;n<e.length;n++){let r=e.charCodeAt(n);if(r<=127)t.push(r);else if(r<=2047)t.push(192|r>>6,128|63&r);else if(55296===(64512&r)){const s=n<e.length-1&&56320===(64512&e.charCodeAt(n+1));if(s){const s=r,o=e.charCodeAt(++n);r=65536|(1023&s)<<10|1023&o,t.push(240|r>>18,128|r>>12&63,128|r>>6&63,128|63&r)}else t.push(239,191,189)}else 56320===(64512&r)?t.push(239,191,189):t.push(224|r>>12,128|r>>6&63,128|63&r)}return new Uint8Array(t)}function Ue(e){let t;try{t=decodeURIComponent(e)}catch(n){throw J(Ee.DATA_URL,"Malformed data URL.")}return Se(t)}function Ce(e,t){switch(e){case Ee.BASE64:{const n=-1!==t.indexOf("-"),r=-1!==t.indexOf("_");if(n||r){const t=n?"-":"_";throw J(e,"Invalid character '"+t+"' found: is it base64url encoded?")}break}case Ee.BASE64URL:{const n=-1!==t.indexOf("+"),r=-1!==t.indexOf("/");if(n||r){const t=n?"+":"/";throw J(e,"Invalid character '"+t+"' found: is it base64 encoded?")}t=t.replace(/-/g,"+").replace(/_/g,"/");break}}let n;try{n=Te(t)}catch(s){if(s.message.includes("polyfill"))throw s;throw J(e,"Invalid character found")}const r=new Uint8Array(n.length);for(let o=0;o<n.length;o++)r[o]=n.charCodeAt(o);return r}class Oe{constructor(e){this.base64=!1,this.contentType=null;const t=e.match(/^data:([^,]+)?,/);if(null===t)throw J(Ee.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const n=t[1]||null;null!=n&&(this.base64=Ie(n,";base64"),this.contentType=this.base64?n.substring(0,n.length-7):n),this.rest=e.substring(e.indexOf(",")+1)}}function Ne(e){const t=new Oe(e);return t.base64?Ce(Ee.BASE64,t.rest):Ue(t.rest)}function xe(e){const t=new Oe(e);return t.contentType}function Ie(e,t){const n=e.length>=t.length;return!!n&&e.substring(e.length-t.length)===t}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rt(e){return/^[A-Za-z]+:\/\//.test(e)}function At(e,t){return new yt(e,t)}function St(e,t){if(e instanceof Nt){const n=e;if(null==n._bucket)throw H();const r=new yt(n,n._bucket);return null!=t?St(r,t):r}return void 0!==t?Et(e,t):e}function Ut(e,t){if(t&&Rt(t)){if(e instanceof Nt)return At(e,t);throw X("To use ref(service, url), the first argument must be a Storage instance.")}return St(e,t)}function Ct(e,t){const n=null===t||void 0===t?void 0:t[R];return null==n?null:Q.makeFromBucketSpec(n,e)}function Ot(e,t,n,r={}){e.host=`${t}:${n}`,e._protocol="http";const{mockUserToken:s}=r;s&&(e._overrideAuthToken="string"===typeof s?s:(0,k.Sg)(s,e.app.options.projectId))}class Nt{constructor(e,t,n,r,s){this.app=e,this._authProvider=t,this._appCheckProvider=n,this._url=r,this._firebaseVersion=s,this._bucket=null,this._host=E,this._protocol="https",this._appId=null,this._deleted=!1,this._maxOperationRetryTime=A,this._maxUploadRetryTime=S,this._requests=new Set,this._bucket=null!=r?Q.makeFromBucketSpec(r,this._host):Ct(this._host,this.app.options)}get host(){return this._host}set host(e){this._host=e,null!=this._url?this._bucket=Q.makeFromBucketSpec(this._url,e):this._bucket=Ct(e,this.app.options)}get maxUploadRetryTime(){return this._maxUploadRetryTime}set maxUploadRetryTime(e){he("time",0,Number.POSITIVE_INFINITY,e),this._maxUploadRetryTime=e}get maxOperationRetryTime(){return this._maxOperationRetryTime}set maxOperationRetryTime(e){he("time",0,Number.POSITIVE_INFINITY,e),this._maxOperationRetryTime=e}async _getAuthToken(){if(this._overrideAuthToken)return this._overrideAuthToken;const e=this._authProvider.getImmediate({optional:!0});if(e){const t=await e.getToken();if(null!==t)return t.accessToken}return null}async _getAppCheckToken(){const e=this._appCheckProvider.getImmediate({optional:!0});if(e){const t=await e.getToken();return t.token}return null}_delete(){return this._deleted||(this._deleted=!0,this._requests.forEach((e=>e.cancel())),this._requests.clear()),Promise.resolve()}_makeStorageReference(e){return new yt(this,e)}_makeRequest(e,t,n,r,s=!0){if(this._deleted)return new ee(K());{const o=be(e,this._appId,n,r,t,this._firebaseVersion,s);return this._requests.add(o),o.getPromise().then((()=>this._requests.delete(o)),(()=>this._requests.delete(o))),o}}async makeRequestWithTokens(e,t){const[n,r]=await Promise.all([this._getAuthToken(),this._getAppCheckToken()]);return this._makeRequest(e,t,n,r).getPromise()}}const xt="@firebase/storage",It="0.11.2",Dt="storage";function Pt(e,t,n){return e=(0,k.m9)(e),kt(e,t,n)}function Lt(e){return e=(0,k.m9)(e),Tt(e)}function Ft(e,t){return e=(0,k.m9)(e),Ut(e,t)}function qt(e=(0,y.getApp)(),t){e=(0,k.m9)(e);const n=(0,y._getProvider)(e,Dt),r=n.getImmediate({identifier:t}),s=(0,k.P0)("storage");return s&&Bt(r,...s),r}function Bt(e,t,n,r={}){Ot(e,t,n,r)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
...
//# sourceMappingURL=community.a9690c29.js.map